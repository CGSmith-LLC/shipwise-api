...
class Country extends \yii\db\ActiveRecord
{
    ...
    public static function getNameByIsoCode($code)
    {
        return self::exists($code) ? self::$list[$code] : false;
    }
    ...
    /**
     * Map country ISO code to carrier's code
     *
     * @param string  $countryIsoCode Country ISO 3166 code
     * @param Carrier $carrier        ShipWise carrier code
     *
     * @return string
     */
    public static function map($countryIsoCode, $carrier)
    {
        $code = $countryIsoCode;
        ...
        if (!empty($carrier)) {
            ...
            $exceptions = [
                ...
                'KN' => [Carrier::FEDEX => 'KN'],
                'BL' => [Carrier::FEDEX => 'GP'],
                //'ES' => [Carrier::_FedEx => 'ES'],
            ];

            if (isset($exceptions[$countryIsoCode])) {
                $code = $exceptions[$countryIsoCode][$carrier];
            }
        }
        return $code;
    }
